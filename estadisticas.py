...
if __name__ == "__main__":
    ...
    Paths = glob("/Users/agustincastillo/Downloads/valid/Annotations/*.xml")
    for p in Paths:
        getStatics(p)
    ...
    for i in [0, 1, 2]:
        ...
        print('{} : {}'.format(name_change[0],
              contador_objetos_size[i].count(0)))
        print('{} : {}'.format(name_change[1],
              contador_objetos_size[i].count(1)))
        print('{} : {}'.format(name_change[2],
              contador_objetos_size[i].count(2)))
        print('{} : {}'.format(name_change[3],
              contador_objetos_size[i].count(3)))
        print('{} : {}'.format(name_change[4],
              contador_objetos_size[i].count(4)))
